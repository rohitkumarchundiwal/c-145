...
label_name_tag = canvas.create_text(30,100, font=('Times', '12', 'bold') ,text="                          Name : Winnie the Pooh")
label_dob_tag = canvas.create_text(52,120, font=('Times', '12', 'bold') ,text="                         Date of birth : 21 August 1921")
label_pin_tag = canvas.create_text(32,140, font=('Times', '12', 'bold') ,text="            Pin no. : 451478")
label_address_tag = canvas.create_text(36,160, font=('Times', '12', 'bold') ,text="                                          Address : Disney Land, Hong Kong")
...
def add() :
    ...
    label_vehicle_Type["text"] = vehicleType
